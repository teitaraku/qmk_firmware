...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[DEFAULT_LAYER] = KEYMAP(
		...
		KC_LSFT, KC_Z, 	KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_CAPS, TG(NUMS_LAYER),
								KC_LALT, KC_LGUI, F(0), KC_RGUI, MO(NUMS_LAYER)
	),
	...
	[THUMB_LAYER] = KEYMAP(
		...
		_______, _______, _______, _______, _______, 		_______, 				KC_PGUP, _______, KC_UP, _______, _______, _______, _______, KC_DEL,
		KC_CAPS, _______, _______, _______, _______, 		_______, 				KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______,
		_______, _______, _______, _______, _______, 		TMUX, 				KC_HOME, KC_END, KC_INS, _______, _______, _______, _______,
...
const uint16_t PROGMEM fn_actions[] = {
	[0] = ACTION_LAYER_TAP_KEY(THUMB_LAYER, KC_SPACE),
};
