...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEFAULT_LAYER] = KEYMAP_HHKB_ARROW( \
    ...
    KC_CAPS,  KC_LALT,  KC_LGUI,  GUI_T(KC_SPC),      MO(THUMB_LAYER),      KC_SPC,  KC_LGUI, TG(NUM_LAYER),  KC_LEFT, KC_DOWN, KC_RIGHT \
  ),

  [THUMB_LAYER] = KEYMAP_HHKB_ARROW( \
    MO(MOD_LAYER),  KC_F1,  KC_F2,  KC_F3,  KC_F4,   _______,   _______,  _______,  KC_MPRV,   KC_MPLY,  KC_MNXT, KC_VOLD, KC_VOLU, _______, _______, \
    _______,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,   _______,   KC_UNDS,   KC_PLUS,   KC_LCBR,   KC_RCBR,   _______, _______, _______, \
    _______,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   _______,   _______,   KC_MINS,   KC_EQL,   KC_LBRC, KC_RBRC,  _______, _______, \
    KC_CAPS,   _______,   _______,   _______,   _______,   LCTL(KC_B),   _______,   _______,    _______,     _______,  KC_PPLS,  KC_PGUP, KC_INS, \
    _______,  _______,  _______, _______,      _______,         _______,               _______, _______,  KC_HOME, KC_PGDN, KC_END \
  ),

  [NUM_LAYER] = KEYMAP_HHKB_ARROW( \
